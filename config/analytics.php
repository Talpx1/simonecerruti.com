...
return [
    ...
    'pan' => [
        ...
        'allowed_analytics' => [
            ...
            'cta-social-linkedin-about',
            'cta-social-instagram-about',
            'cta-social-github-about',
            'cta-social-bluesky-about',
            'cta-social-x-about',
            'cta-hero-projects',
            'cta-hero-contacts',
            ...
            'cta-contacts-submit',
            'cta-home-about-anecdote',
            'cta-home-about-method',
            'cta-home-about-more',
            'cta-home-method',
            'cta-home-blog-practical',
            'cta-home-blog-technical',
            'cta-about-method',
            'cta-about-card-method',
            'cta-about-card-projects',
            'cta-about-email',
            'cta-about-contacts',
            'cta-projects-load-more',
            'cta-projects-contacts',
            'cta-project-visit-site',
            'cta-project-website',
            'cta-project-related-link',
            'cta-project-contacts',
            'cta-blog-featured-read',
            'cta-blog-load-more',
            'cta-blog-article-related',
            'cta-blog-article-contacts',
            'cta-method-contacts',
            'cta-method-projects',
            'cta-method-services',
            'cta-home-services',
            'cta-projects-services',
            'cta-project-services',
            'cta-project-projects',
            'cta-blog-article-services',
            'cta-card-project-visit-site',
            'card-project-click',
            'card-blog-click',
