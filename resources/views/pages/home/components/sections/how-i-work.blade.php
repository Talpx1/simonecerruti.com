<section class="flex flex-col justify-around min-h-screen h-screen max-h-screen">
    <div class="space-y-4">
        ...
        <div
            ...
            <span class="text-dark flex w-full max-w-full flex-nowrap text-6xl font-black uppercase py-4">
    ...
    <div class="mx-auto flex flex-col gap-4 text-center w-fit">
        <div class="flex flex-col gap-1">
            ...
            <div class="flex justify-center gap-8 text-5xl font-black">
                <span>{{ __('RELIABLE') }}</span> / <span>{{ __('INTUITIVE') }}</span> /
