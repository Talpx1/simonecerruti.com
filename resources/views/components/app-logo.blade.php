...
@if ($weight === 'thin')
    <svg {{ $attributes }} preserveAspectRatio="xMidYMid meet" viewBox="0 0 96 51" fill="none"
        ...
        <path
            ...
            stroke="#fff" stroke-width="2" stroke-linecap="square" stroke-linejoin="bevel" />
    </svg>
@elseif ($weight === 'medium')
    <svg {{ $attributes }} preserveAspectRatio="xMidYMid meet" viewBox="0 0 100 54" fill="none"
        ...
        <path
            ...
            stroke="#fff" stroke-width="5" stroke-linecap="square" stroke-linejoin="bevel" />
    </svg>
@elseif ($weight === 'bold')
    <svg {{ $attributes }} preserveAspectRatio="xMidYMid meet" viewBox="0 0 104 59" fill="none"
        ...
        <path
            ...
            stroke="#fff" stroke-width="10" stroke-linecap="square" stroke-linejoin="bevel" />
    </svg>
@endif
